...
import { REFERENCE_TYPES, formatReference, formatCitation } from '../utils/formatters';
      ...
      {references.map((reference) => (
        <div key={reference.id} className="reference-item">
          <div className="reference-header">
            ...
            <div className="reference-actions">
              <button
                ...
                onClick={() => onCopy(formatCitation(reference), 'インライン引用をコピーしました')}
                title="インライン引用をコピー"
              >
                📝 引用
              </button>
              <button
                ...
                onClick={() => onCopy(formatReference(reference), '参考文献をコピーしました')}
                title="参考文献をコピー"
              >
                📋 参考文献
              </button>
          ...
          <div className="citation-preview">
            <strong>本文中の引用例:</strong> {formatCitation(reference, 'XX')}
          </div>
